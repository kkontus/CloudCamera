...
public class BoxSenderService extends IntentService implements MessageService {
     ...
     */
    public BoxSenderService(String name) {
        super(name);
    }

    public BoxSenderService() {
        super("BoxSenderService");
