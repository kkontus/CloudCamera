...
public class DropboxSenderService extends IntentService implements MessageService {
     ...
     */
    public DropboxSenderService(String name) {
        super(name);
    }

    public DropboxSenderService() {
        super("DropboxSenderService");
