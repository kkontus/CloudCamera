...
public class OneDriveSenderService extends IntentService implements MessageService {
     ...
     */
    public OneDriveSenderService(String name) {
        super(name);
    }

    public OneDriveSenderService() {
        super("OneDriveSenderService");
