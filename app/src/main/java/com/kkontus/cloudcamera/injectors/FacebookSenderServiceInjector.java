...
import com.kkontus.cloudcamera.services.FacebookSenderService;

public class FacebookSenderServiceInjector implements MessageServiceInjector {

    @Override
    public Consumer getConsumer() {
        Sender app = new Sender();
        app.setService(new FacebookSenderService());
        return app;
    }
