...
import com.kkontus.cloudcamera.services.OneDriveSenderService;

public class OneDriveSenderServiceInjector implements MessageServiceInjector {

    @Override
    public Consumer getConsumer() {
        Sender app = new Sender();
        app.setService(new OneDriveSenderService());
        return app;
    }
